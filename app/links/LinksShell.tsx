...
export function LinksShell({ userEmail, userName }: Props) {
    ...
    <>
      ...
      <div className="mt-auto border-t border-border pt-4">
        <div className="flex items-center gap-3 px-3 py-2">
          <div className="flex size-9 shrink-0 items-center justify-center rounded-md bg-primary/10 text-sm font-medium text-primary">
  ...
  return (
    <>
      <header className="flex h-14 shrink-0 items-center gap-2 border-b border-border bg-background px-4 md:hidden">
        ...
        <Link href="/links" className="text-lg font-semibold tracking-tight">
          shrtnr
        </Link>
      </header>
